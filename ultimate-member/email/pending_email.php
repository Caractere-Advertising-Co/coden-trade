<div style="width:500px;text-align:center;font-family:'montserrat',sans-serif;">
    ...
    <a href="http://coden.caractere-advertising.be" style="color:#fff;text-transform: uppercase;background: #a42e2b;width: fit-content;padding: 10px 20px;margin: auto;margin-bottom:20px;display: block;text-decoration: none;letter-spacing: 4px;font-size: 1.2rem;">Visiter la boutique</a>

    <p style="font-style:italic; font-size: .8rem;margin-bottom:30px;">Veuillez nous accorder un certain temps pour traiter votre<br> demande et examiner vos informations.</p>

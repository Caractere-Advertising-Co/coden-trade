<div style="width:500px;text-align:center;font-family:'montserrat',sans-serif;margin:auto;">
    ...
    <h1 style="text-transform:uppercase;font-size:2rem;color:#000;font-family:'Montserrat',sans-serif;font-weight:200">
        Suppression<br>de votre compte
    </h1>

    <p style="padding: 30px 0;font-size: 1.2rem;text-align: center;line-height: 2rem;">
        Votre compte vient d'être supprimé.<br>
        Toutes vos détails personnels et téléchargmeent ont été supprimés définitivement.<br><br>

        Si votre compte a été supprimé par accident, veuillez <a href="mailto:{admin_email}">nous contacter</a>.
    </p>
